    ...
    return (
      <div className='container'>
        ...
        <div className='media-list'>
          <Destination description='Influence relationships from Wikidata, time-based layout'
                      href='#/galaxy/wikidata?l=1'
                      media='wikidata_300px.png'
                      name='Wikidata Influences'/>
          <Destination description='Influence relationships from Wikidata, without times'
                      href='#/galaxy/wikidata-notime?l=1'
                      media='wikidata_notime_300px.png'
                      name='Wikidata Influences'/>
